...
(defn create-col-me-arc
  ;([col-id me-id data ds]
  ; (create-col-me-arc col-id me-id data ds))
  ...
  (try
    (catcher/with-logging {}
      (let [col-id (-> req :parameters :path :collection_id)
        ...
        (if-let [ins-res (create-col-me-arc col-id me-id data ds)]
