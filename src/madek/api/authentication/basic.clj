...
;                                                                                                     {:login-or-email-address login-or-email})}}
;      :else (do
;              (println ">o> add is-admin" (sd/is-admin (or (:id entity) (:user_id entity)) tx) )
...
;      x(when [user-token (token-authentication/find-user-token-by-some-secret [username password] (:tx request))]
;        (do
;          (println ">o> find-user-token-by-some-secret")
;          (token-authentication/authenticate user-token handler request))
;
;        ;(do
;        ;  (println ">o> user-password-authentication")
