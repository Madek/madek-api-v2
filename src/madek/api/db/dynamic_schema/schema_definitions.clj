...
;; Exmaples
;; http://localhost:3104/api-docs/index.html#/groups/get_api_groups_
;; http://localhost:3104/swagger.json
(def create-groups-schema [{:raw [{:groups {}}
                            ...
                            :schemas [{:groups.schema-query-groups {:key-types "optional" ;; REQUEST-PARAMETERS-QUERY
                           ...
                           {:raw [{:groups {}}],
                            ...
                            :schemas [{:groups.schema-update-group {:alias "schema_update-group"
                                      ...
                                      {:groups.schema-export-group {:alias "schema_export-group" ;; RESPONSE-BODY
...
(def keywords-schema-cfg [{:raw [{:keywords {}}
                             {:_additional [{:column_name "external_uri", :data_type "str"}]}],
                       :raw-schema-name :keywords-extended-raw
                       :schemas [{:keywords.schema_export_keyword_usr {:alias "mar.keywords/schema_export_keyword_usr"
                                                                       :types [{:description {:value-type TYPE_MAYBE}}
...
;;(defn keywords-schema-fnc-ab  []
;(defn keywords-schema-fnc  []
;  (println ">o> keywords-schema-fnc ?????????????")
;  "test-fetch")
