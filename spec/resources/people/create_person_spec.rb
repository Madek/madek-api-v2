...
expected_audit_entries = ["INSERT people", "INSERT usage_terms", "INSERT users", "INSERT auth_systems_users",
  "INSERT admins", *(["INSERT admin_permissions"] * AdminPermission::KEYS.size), "INSERT api_tokens", "INSERT people"]
