  ...
  context "revoking the token " do
    {
      ...
      "/api-v2/admin/delegations/users/" => 403,
      "/api-v2/admin/delegations/groups/" => 403,
      "/api-v2/admin/edit_sessions/" => 403,
      "/api-v2/admin/favorites/collections/" => 403,
      "/api-v2/admin/favorites/media-entries/" => 403,
      ...
      context "against GET endpoints " do
        {
          ...
          "/api-v2/admin/delegations/users/" => 200,
          "/api-v2/admin/delegations/groups/" => 200,
          "/api-v2/admin/edit_sessions/" => 200,
          "/api-v2/admin/favorites/collections/" => 200,
          "/api-v2/admin/favorites/media-entries/" => 200,
